...
resourcename="absencemanagement"  # lower case, only
resourcegroup="absencemanagement_rg"
...
# git clone https://github.com/apilogicserver/absencemanagement.git
...
az group create --name absencemanagement_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group absencemanagement_rg --sku S1 --is-linux
az container create --resource-group absencemanagement_rg --name absencemanagement --image apilogicserver/absencemanagement:latest --dns-name-label absencemanagement --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//absencemanagement.westus.azurecontainer.io:5656'
