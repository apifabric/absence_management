...
@Component({
  selector: 'TrainingProgram-home',
  templateUrl: './TrainingProgram-home.component.html',
  styleUrls: ['./TrainingProgram-home.component.scss']
})
export class TrainingProgramHomeComponent implements AfterViewInit {
