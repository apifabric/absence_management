...
@Component({
  selector: 'LeaveBalance-home',
  templateUrl: './LeaveBalance-home.component.html',
  styleUrls: ['./LeaveBalance-home.component.scss']
})
export class LeaveBalanceHomeComponent implements AfterViewInit {
