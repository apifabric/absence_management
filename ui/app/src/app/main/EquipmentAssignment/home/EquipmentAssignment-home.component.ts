...
@Component({
  selector: 'EquipmentAssignment-home',
  templateUrl: './EquipmentAssignment-home.component.html',
  styleUrls: ['./EquipmentAssignment-home.component.scss']
})
export class EquipmentAssignmentHomeComponent implements AfterViewInit {
