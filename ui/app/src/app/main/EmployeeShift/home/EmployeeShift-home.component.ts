...
@Component({
  selector: 'EmployeeShift-home',
  templateUrl: './EmployeeShift-home.component.html',
  styleUrls: ['./EmployeeShift-home.component.scss']
})
export class EmployeeShiftHomeComponent implements AfterViewInit {
