...
@Component({
  selector: 'OvertimeRecord-home',
  templateUrl: './OvertimeRecord-home.component.html',
  styleUrls: ['./OvertimeRecord-home.component.scss']
})
export class OvertimeRecordHomeComponent implements AfterViewInit {
