...
@Component({
  selector: 'EmployeeLocation-home',
  templateUrl: './EmployeeLocation-home.component.html',
  styleUrls: ['./EmployeeLocation-home.component.scss']
})
export class EmployeeLocationHomeComponent implements AfterViewInit {
