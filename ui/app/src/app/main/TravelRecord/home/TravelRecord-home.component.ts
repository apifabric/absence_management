...
@Component({
  selector: 'TravelRecord-home',
  templateUrl: './TravelRecord-home.component.html',
  styleUrls: ['./TravelRecord-home.component.scss']
})
export class TravelRecordHomeComponent implements AfterViewInit {
