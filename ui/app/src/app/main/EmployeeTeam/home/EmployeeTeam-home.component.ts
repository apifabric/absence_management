...
@Component({
  selector: 'EmployeeTeam-home',
  templateUrl: './EmployeeTeam-home.component.html',
  styleUrls: ['./EmployeeTeam-home.component.scss']
})
export class EmployeeTeamHomeComponent implements AfterViewInit {
